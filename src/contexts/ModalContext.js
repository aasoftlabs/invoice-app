            ...
            <div className="p-6">
              ...
              <div className="mt-8 flex gap-3">
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-2.5 rounded-xl font-medium text-white shadow-lg shadow-blue-500/20 transition-all hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-slate-800 ${
                    modal.variant === "danger"
