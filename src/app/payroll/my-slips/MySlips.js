              ...
              <div className="flex gap-2">
                ...
                {session?.user?.role === "admin" ? (
                  <button
                    ...
                    disabled={actionLoading === slip._id}
                    className={`group flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
                      slip.emailSent
                        ? "border border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 hover:bg-gray-50 dark:hover:bg-slate-700 hover:text-blue-600 dark:hover:text-blue-400 hover:border-gray-300 dark:hover:border-slate-600"
                        : "border border-gray-300 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-slate-700 text-blue-600 dark:text-blue-400"
                    }`}
                    title={
                      slip.emailSent
                        ? `Email sent on ${new Date(slip.emailSentAt).toLocaleString()}. Click to send again.`
                        : "Send Email"
                    }
                  >
                    {slip.emailSent ? (
                      <>
                        ...
                        <Send className="w-4 h-4 hidden group-hover:block" />
                      </>
                    ) : (
                  ...
                  /* User View: Only show if sent */
                  slip.emailSent && (
                    <button
                      disabled
                      className="flex items-center justify-center gap-2 px-3 py-2 border border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-lg text-sm font-medium cursor-default disabled:opacity-100"
