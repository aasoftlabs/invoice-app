...
export async function POST(req) {
    ...
    try {
        ...
        const { userId, month, year, lopDays = 0, notes, overwrite = false } = await req.json();
        ...
        const adjustedEarnings = {
            ...
            mobileExpense: Math.round((salaryStructure.mobileExpense || 0) * lopRatio),
        ...
        const slip = await SalarySlip.create({
            ...
            netPay: adjustedEarnings.gross - (calculated.deductions.total + lopAmount),
