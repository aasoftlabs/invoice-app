...
export async function PUT(req, { params }) {
    ...
    try {
        ...
        if (role) {
            ...
            // Auto-set permissions for admin
            if (role === "admin") {
                updateData.permissions = ["invoices", "letterhead", "project", "company", "users", "profile"];
            }
        }
        if (permissions && role !== "admin") updateData.permissions = permissions;
