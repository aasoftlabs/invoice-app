...
function NoteBadge({ note }) {
  ...
  return (
    ...
    >
      ...
      {isHovered ? <div className="absolute top-full left-0 mt-3 z-[100] w-72 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-slate-700 p-5 transform transition-all duration-200">
          {/* Arrow */}
          <div className="absolute -top-1.5 left-10 w-3 h-3 bg-white dark:bg-slate-800 border-l border-t border-gray-200 dark:border-slate-700 rotate-45" />
