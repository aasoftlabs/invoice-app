                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-1">
                        <input
                          ...
                          className={`w-16 px-2 py-1 border rounded text-sm ${lopData[emp._id]?.isManual
                        ...
                        <button
                          ...
                          className={`p-1 rounded-md transition-colors ${lopData[emp._id]?.isManual
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    {slip && (
                      <span
                        className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${slip.status === "paid"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className={`w-full max-w-[80px] px-3 py-2 border rounded-xl font-bold text-sm ${lopData[emp._id]?.isManual
                      ...
                      <button
                        ...
                        className={`p-2 rounded-xl transition-all shadow-sm ${lopData[emp._id]?.isManual
