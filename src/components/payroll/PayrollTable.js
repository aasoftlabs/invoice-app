        ...
        <table className="w-full text-left">
          <thead className="bg-gray-50 dark:bg-slate-900 text-gray-500 dark:text-slate-400 text-xs uppercase font-semibold border-b dark:border-slate-700">
            <tr>
              ...
              <th className="px-6 py-3 hidden lg:table-cell">Emp Code</th>
              <th className="px-6 py-3">Department</th>
              <th className="px-6 py-3 hidden lg:table-cell">DOJ</th>
              <th className="px-6 py-3 hidden xl:table-cell">State</th>
              <th className="px-6 py-3">Gross Salary</th>
              <th className="px-6 py-3">Deductions</th>
              <th className="px-6 py-3">Net Salary</th>
              <th className="px-6 py-3 whitespace-nowrap text-right min-w-[120px]">
                Actions
              </th>
            </tr>
          </thead>
                  ...
                  <td className="px-6 py-4 text-right whitespace-nowrap">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 p-1.5 hover:bg-blue-50 dark:hover:bg-blue-900/40 rounded-lg transition-all cursor-pointer active:scale-90"
