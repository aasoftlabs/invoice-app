...
export default function InvoiceFooter({ isSaving, isEditing }) {
  return (
    <div className="border-t border-gray-100 dark:border-slate-700 p-6 bg-white dark:bg-slate-800 shrink-0 z-10 flex gap-3 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
      <button
        type="submit"
        form="invoice-form"
        disabled={isSaving}
