  ...
  <div class="container">
    <div class="header">
      <div style="text-align: center; margin-bottom: 10px;">
        <img src="https://aasoftlabs.com/logo.png" alt="AASoftLabs" style="height: 35px; width: auto; vertical-align: middle;" />
        <span style="display: inline-block; vertical-align: middle; margin-left: 8px;">
          <span style="color: #2563eb; font-size: 20px; font-weight: bold;">AA</span>
          <span style="color: #4b5563; font-size: 20px; font-weight: bold;">SoftLabs</span>
          <sup style="color: #9ca3af; font-size: 9px; margin-left: 1px;">™</sup>
        </span>
      </div>
